...
# taken from racingmars/dotfiles

# meant to be installed on a new system, from the user's home directory,
# with something like:
# curl -s https://raw.githubusercontent.com/barturba/dotfiles/master/install.sh | sh
#
...
git clone https://github.com/barturba/dotfiles.git lib/dotfiles
